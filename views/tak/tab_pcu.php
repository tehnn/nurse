...
from data_pcu d WHERE d.kpi =t.id and d.rep=2558 AND d.prov =63 AND d.amp=01) as '01'

,(SELECT IF(t.id not in (6,7,8,9),FORMAT(SUM(d.total),0),ROUND(AVG(d.total),2)) 
from data_pcu d WHERE d.kpi =t.id and d.rep=2558 AND d.prov =63 AND d.amp=02) as '02'

,(SELECT IF(t.id not in (6,7,8,9),FORMAT(SUM(d.total),0),ROUND(AVG(d.total),2)) 
from data_pcu d WHERE d.kpi =t.id and d.rep=2558 AND d.prov =63 AND d.amp=03) as '03'

,(SELECT IF(t.id not in (6,7,8,9),FORMAT(SUM(d.total),0),ROUND(AVG(d.total),2)) 
from data_pcu d WHERE d.kpi =t.id and d.rep=2558 AND d.prov =63 AND d.amp=04) as '04'

,(SELECT IF(t.id not in (6,7,8,9),FORMAT(SUM(d.total),0),ROUND(AVG(d.total),2)) 
from data_pcu d WHERE d.kpi =t.id and d.rep=2558 AND d.prov =63 AND d.amp=05) as '05'

,(SELECT IF(t.id not in (6,7,8,9),FORMAT(SUM(d.total),0),ROUND(AVG(d.total),2)) 
from data_pcu d WHERE d.kpi =t.id and d.rep=2558 AND d.prov =63 AND d.amp=06) as '06'

,(SELECT IF(t.id not in (6,7,8,9),FORMAT(SUM(d.total),0),ROUND(AVG(d.total),2)) 
from data_pcu d WHERE d.kpi =t.id and d.rep=2558 AND d.prov =63 AND d.amp=07) as '07'

,(SELECT IF(t.id not in (6,7,8,9),FORMAT(SUM(d.total),0),ROUND(AVG(d.total),2)) 
from data_pcu d WHERE d.kpi =t.id and d.rep=2558 AND d.prov =63 AND d.amp=08) as '08'

,(SELECT IF(t.id not in (6,7,8,9),FORMAT(SUM(d.total),0),ROUND(AVG(d.total),2)) 
from data_pcu d WHERE d.kpi =t.id and d.rep=2558 AND d.prov =63 AND d.amp=09) as '09'

,(SELECT IF(t.id not in (6,7,8,9),FORMAT(SUM(d.total),0),ROUND(AVG(d.total),2)) 
from data_pcu d WHERE d.kpi =t.id and d.rep=2558 AND d.prov =63 AND d.amp=09) as '10'


,(SELECT IF(t.id not in (6,7,8,9),FORMAT(SUM(d.total),0),ROUND(AVG(d.total),2)) 
from data_pcu d WHERE d.kpi =t.id AND d.prov=63) as 'all' 
